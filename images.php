...
{?>
    <div class="col-lg-3 col-md-3 col-sm-3 ">
                ...
                <div class="portfolio-item">
                    ...
                    <img src="getimages.php?id=<?php echo $row[0];?>" class="img-responsive " alt="" />

                    <div class="overlay">



                        <a class="preview btn btn-success " title=" <?php echo $row[1];?>" href="getimages.php?id=<?php echo $row[0];?>">enlarge</a>
                        <p>
                            <?php echo $row[2];?>
                        </p>

                        <a class="preview"  href="getimages.php?id=<?php echo $row[0];?>" ></a>
                    </div>
                </div>
